...
<c:forEach var="receita" items="${receita}">
...
</li><br><br><br><br><br><input type="button" value="Voltar" color="#505050" onclick="javascript:history.go(-1)"><br></div><div id="footer" style="background-color:#C0C0C0;clear:both;text-align:center;">
